...
class _$ProductItemImpl implements _ProductItem {
  ...
  @override
  String toString() {
    return 'ProductItem(productId: $productId, productName: $productName, price: $price, adjustedTax: $adjustedTax, basePrice: $basePrice, bonusProductLineItem: $bonusProductLineItem, gift: $gift, itemId: $itemId, itemText: $itemText, priceAfterItemDiscount: $priceAfterItemDiscount, priceAfterOrderDiscount: $priceAfterOrderDiscount, quantity: $quantity, shipmentId: $shipmentId, tax: $tax, taxBasis: $taxBasis, taxClassId: $taxClassId, taxRate: $taxRate)';
  }
...
abstract class _ProductItem implements ProductItem {
  factory _ProductItem(
      ...
      required final double taxRate}) = _$ProductItemImpl;
